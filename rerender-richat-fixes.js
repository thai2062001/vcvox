...
const targetIndices = [2, 3, 6, 8, 20, 29, 47];
...
async function rerenderFlawed() {
  console.log(`Bắt đầu re-render ${targetIndices.length} câu đã sửa lỗi phát âm...`);
  ...
  console.log("\n🎉 Hoàn tất re-render và cập nhật manifest thành công 100%!");
}

rerenderFlawed().catch(console.error);
